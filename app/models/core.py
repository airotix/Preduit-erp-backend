...
class Tenant(Base):
    ...
    tax_registration: Mapped[str | None] = mapped_column(String(60), nullable=True)
    # Company profile — one typed column per field (see V045).
    about: Mapped[str | None] = mapped_column(String(400), nullable=True)
    logo_doc_id: Mapped[str | None] = mapped_column(String(64), nullable=True)
    cover_doc_id: Mapped[str | None] = mapped_column(String(64), nullable=True)
    ...
    sales_model: Mapped[str | None] = mapped_column(String(60), nullable=True)
    founded: Mapped[str | None] = mapped_column(String(10), nullable=True)
    street: Mapped[str | None] = mapped_column(String(200), nullable=True)
    state: Mapped[str | None] = mapped_column("state", String(80), nullable=True)
    ...
    support_line: Mapped[str | None] = mapped_column(String(40), nullable=True)
    opening_hours: Mapped[str | None] = mapped_column(String(120), nullable=True)
    website: Mapped[str | None] = mapped_column(String(200), nullable=True)
    social_linkedin: Mapped[str | None] = mapped_column(String(120), nullable=True)
    social_instagram: Mapped[str | None] = mapped_column(String(120), nullable=True)
    social_facebook: Mapped[str | None] = mapped_column(String(120), nullable=True)
    social_x: Mapped[str | None] = mapped_column(String(120), nullable=True)
